...
Referify turns your consumers into brand ambassadors, by offering a cashback incentive to share your website with their friends and family.

This Referify plugin adds a share box to your thank your page (see screenshots), and gives your site a referral tracking program to reward customers for sharing your website.

Consumers trust their friends - using Referify enables you to encourage social sharing, which can increase your brand exposure, and ultimately your sales. Signing Up to Referify is completely FREE, and you only pay commission when successful transactions are made.

The commission cost is 10% for the consumers, and 3% for Referify of the total transaction value, and ONLY when successful transactions are made.

You can also set up an offer for the person being referred to you, by setting up a discount code for your checkout.
...
The cashback amount to the customer is 10% of the total transaction value, and the cost paid Referify is 3% of the transaction value.

= What do I need to do? =
As a WooCommerce store owner, to use Referify you just need to install this plugin, and then Sign Up to Referify, which to totally FREE.

You will then be given a unique Retailer ID, and an API secret, which you will be asked to add in this plugin admin screen.

Doing this links your website store, to Referify, and allows you to see reports on how many people are sharing your site, and how many transaction are being created as a result.
...
The total cost per approved transaction is 13% of the total transaction amount. Referify pass 10% on to the consumer who shared your site, and takes 3% as a service fee.
...
= 1.2 =
* Added share box shortcode

= 1.3 =
* Added javascript for referred box offer

= 1.4 =
* Improved share box styling
